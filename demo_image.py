...
def predict(image_path, test_dir, weight, threshold, config, model):
...
if __name__ == '__main__':
    args = get_args()
    predict(args.image_path, args.test_dir, args.weight, args.threshold, args.config, args.model)